...
//     } else {
//       setShowResult(true);
//       // Determine recommended department based on correct answers
//       if (correctAnswers >= 1) {
//         setRecommendedDepartment("CS");
//       } else {
//         setRecommendedDepartment("Other department");
//       }
//     }
//   };
...
//         Dear student, we can recommend a suitable department for you through this quiz{" "}
//         <span>
...
//           <h1>Final result</h1>
//           <h3>We recommend the {recommendedDepartment} department for you</h3>
//           <button onClick={handleRestartQuiz}>Restart quiz</button>
//         </div>
//       ) : (
//         <div className="col-10 questions">
//           <h3 className="col-12">Question {currentQuestion + 1} out of {questions.length}</h3>
//           <h4 className="col-12 question_text">{questions[currentQuestion].text}</h4>
//           <ul className="col-11">
